...
public class StandaloneKubernetesTaskManagerFactoryTest extends ParametersTestBase {
    ...
    public void setup() {
        ...
        StandaloneKubernetesTaskManagerParameters tmParameters =
                new StandaloneKubernetesTaskManagerParameters(flinkConfig, TestUtils.createClusterSpecification());
        deployment =
                StandaloneKubernetesTaskManagerFactory.buildKubernetesTaskManagerDeployment(podTemplate, tmParameters);
    }

    @Test
    public void testDeploymentMetadata() {
        assertEquals(StandaloneKubernetesUtils.getTaskManagerDeploymentName(TestUtils.CLUSTER_ID),
    ...
    public void testDeploymentSpec() {
        ...
        assertEquals(StandaloneKubernetesUtils.getTaskManagerSelectors(TestUtils.CLUSTER_ID),
