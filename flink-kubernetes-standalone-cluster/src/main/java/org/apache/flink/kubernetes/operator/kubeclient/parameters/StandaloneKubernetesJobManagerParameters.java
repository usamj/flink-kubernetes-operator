...
public class StandaloneKubernetesJobManagerParameters extends KubernetesJobManagerParameters {
    ...
    public boolean isApplicationCluster() {
        return flinkConfig.get(StandaloneKubernetesConfigOptionsInternal.APPLICATION_CLUSTER);
    }
    ...
    public String getMainClass() {
        ...
        return flinkConfig.getString(
                StandaloneKubernetesConfigOptionsInternal.APPLICATION_JAR_MAIN_CLASS);
    }
}
