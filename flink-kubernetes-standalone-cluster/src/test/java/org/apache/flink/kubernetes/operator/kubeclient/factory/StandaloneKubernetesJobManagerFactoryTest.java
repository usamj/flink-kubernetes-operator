...
public class StandaloneKubernetesJobManagerFactoryTest extends ParametersTestBase {
    ...
    public void setup() throws Exception {
        ...
        StandaloneKubernetesJobManagerParameters tmParameters =
                new StandaloneKubernetesJobManagerParameters(flinkConfig, TestUtils.createClusterSpecification());
        jmSpec =
                StandaloneKubernetesJobManagerFactory.buildKubernetesJobManagerSpecification(podTemplate, tmParameters);
    ...
    public void testDeploymentMetadata() {
        ...
        assertEquals(StandaloneKubernetesUtils.getJobManagerDeploymentName(CLUSTER_ID),
    ...
    public void testDeploymentSpec() {
        ...
        assertEquals(StandaloneKubernetesUtils.getJobManagerSelectors(CLUSTER_ID),
    ...
    public void testTemplateMetadata() {
        ...
        final Map<String, String> expectedAnnotations =
                new HashMap<>(userAnnotations);
    ...
    public void testAdditionalResourcesSize() throws IOException {
        final List<HasMetadata> resultAdditionalResources =
                this.jmSpec.getAccompanyingResources();
