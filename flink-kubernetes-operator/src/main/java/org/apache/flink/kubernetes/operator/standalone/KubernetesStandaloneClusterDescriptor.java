...
public class KubernetesStandaloneClusterDescriptor extends KubernetesClusterDescriptor {
    ...
    private final FlinkDeployment flinkDeployment;
    public KubernetesStandaloneClusterDescriptor(
            FlinkDeployment flinkDeployment, Configuration flinkConfig, FlinkStandaloneKubeClient client) {
        super(flinkConfig, client);
        this.flinkDeployment = checkNotNull(flinkDeployment);
